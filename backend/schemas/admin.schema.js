...
// FIX: params key must be 'userId' to match route param :userId and controller param read
const updateUserStatusSchema = {
    params: z.object({
        userId: z.string().uuid('Valid user ID is required'),  // ← was 'id'
    }),
    body: z.object({
...
// FIX: idParamSchema was defined in schema file but never exported — now exported
//      so adminRoute.js can use it on routes missing param validation.
const idParamSchema = {
    params: z.object({
