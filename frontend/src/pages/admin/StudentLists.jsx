  ...
  >
    ...
    <div className="flex justify-between items-start mb-2 w-full absolute top-4 left-0 px-4">
      ...
      <div className="relative z-10">
        ...
        {dropdownOpen && (
          ...
          >
            <div className="py-1">
              <button onClick={() => { onViewDetails(); onToggleDropdown(); }} className="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-700 hover:bg-amber-50 hover:text-amber-700">
                <Eye className="h-4 w-4" /> View Details
              </button>
              <button onClick={() => { onViewHistory(); onToggleDropdown(); }} className="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-700 hover:bg-amber-50 hover:text-amber-700">
                <History className="h-4 w-4" /> View History
              </button>
              <button onClick={onAssignClass} className="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-700 hover:bg-amber-50 hover:text-amber-700">
                <School className="h-4 w-4" /> Assign Class
              </button>
              ...
              <button onClick={() => { onDelete(); onToggleDropdown(); }} className="flex items-center gap-2 w-full px-4 py-2 text-sm text-red-600 hover:bg-red-50">
                <Trash2Icon className="h-4 w-4" /> Delete Student
              </button>
            </div>
          </div>
        )}
    ...
    <div className="flex flex-col items-center text-center mt-4">
      ...
      <div className="flex items-center justify-center gap-1 mt-1 mb-4 text-xs font-medium">
        <span className={`${getStatusColor(studentStatus)}`}>{studentStatus}</span>
        {currentClass?.type && (
          <>
            <span className="text-gray-300 px-1">•</span>
            <span className={`${getClassTypeColor(currentClass.type)}`}>{currentClass.type}</span>
          </>
        )}
      </div>
